...
public class GraphDisplay extends StackPane
{
	...
	public TableView<Location> createLocationTableView()
	{
	    TableView<Location> tableView = new TableView<>();

	    TableColumn<Location, String> nameColumn = new TableColumn<>("Name");
	    nameColumn.setCellValueFactory(new PropertyValueFactory<>("name"));

	    TableColumn<Location, Double> latitudeColumn = new TableColumn<>("Latitude");
	    latitudeColumn.setCellValueFactory(new PropertyValueFactory<>("latitude"));

	    TableColumn<Location, Double> longitudeColumn = new TableColumn<>("Longitude");
	    longitudeColumn.setCellValueFactory(new PropertyValueFactory<>("longitude"));

	    tableView.getColumns().addAll(nameColumn, latitudeColumn, longitudeColumn);
